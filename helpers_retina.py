...
# calculateRayDirections and visualizeRetina are currently unused
...
def main():
    ...
    sys.path.append('..')
    import open3d_tutorial  # tutorial file was moved to 'api_examples', move file back before running this
